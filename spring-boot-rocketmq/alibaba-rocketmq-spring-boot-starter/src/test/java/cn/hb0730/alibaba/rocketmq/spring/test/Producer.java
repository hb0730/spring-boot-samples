...
public class Producer {
    ...
    public void tcpTest(){
        ...
        properties.setProperty(PropertyKeyConst.AccessKey,"LTAI4FnjHtPiL5gvTLbZUzbm");
        properties.setProperty(PropertyKeyConst.SecretKey,"kZjTVq41IDFlVKEVnRBbGPPma6eC2e");
        properties.setProperty(PropertyKeyConst.SendMsgTimeoutMillis,"3000");
        properties.setProperty(PropertyKeyConst.NAMESRV_ADDR,"http://MQ_INST_1317287729996725_Bb74x3UY.cn-hangzhou.mq-internal.aliyuncs.com:8080");
    ...
    public void httpTest(){
        MQClient mqClient=new MQClient("http://1317287729996725.mqrest.cn-hangzhou.aliyuncs.com","LTAI4FnjHtPiL5gvTLbZUzbm","kZjTVq41IDFlVKEVnRBbGPPma6eC2e");
