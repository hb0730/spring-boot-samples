package com.hb0730.alibaba.spring.boot.rabbitmq.config;

import com.hb0730.alibaba.spring.boot.rabbitmq.provider.AliyunCredentialsProvider;
...
public class RabbitConfig {
    //实例Id 从阿里云AMQP控制台获取
    private static final String INSTANCE_ID = "1317287729996725";
    @Autowired
